  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-indigo-50 via-white to-cyan-50">
      <div className="relative">
        ...
        {/* Middle pulsing ring */}
        <div className="absolute inset-2 w-28 h-28 border-4 border-transparent border-t-cyan-400 border-l-blue-400 rounded-full animate-spin animation-delay-150" style={{animationDirection: 'reverse', animationDuration: '1.5s'}}></div>
