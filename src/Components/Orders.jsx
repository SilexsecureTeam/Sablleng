      ...
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 md:px-8">
          ...
          <div className="grid grid-cols-1  gap-4">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#CB5B6A]"
              />
            </div>
            ...
            <select
              ...
              className="px-4 py-2 hidden border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#CB5B6A]"
            >
        ...
        {isLoading ? (
          <div className="bg-white rounded-lg shadow-sm p-8 text-center">
            <Loader2
              size={48}
              className="mx-auto text-[#CB5B6A] animate-spin mb-4"
            />
          ...
          <div className="bg-white rounded-lg shadow-sm p-8 text-center">
            ...
            {!searchQuery && statusFilter === "all" && (
              <a
                href="/product"
                className="inline-block bg-[#CB5B6A] text-white px-6 py-3 rounded-lg hover:bg-[#b34f5c] transition-colors duration-200"
              >
                Start Shopping
              </a>
            )}
                  ...
                  <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <button
                        ...
                        className="flex items-center gap-2 text-[#CB5B6A] hover:text-[#b34f5c] transition-colors duration-200"
                      >
                        <Eye size={18} />
