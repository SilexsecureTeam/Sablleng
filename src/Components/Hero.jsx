...
const Hero = () => {
  return (
    <div
      className="relative bg-cover bg-center min-h-[70vh] sm:min-h-[80vh] md:min-h-[85vh] flex items-center justify-start"
    ...
    >
      ...
      <div className="relative z-10 max-w-[1200px] mx-auto w-full px-4 sm:px-6 md:px-8 py-12 md:py-16">
        <div className="">
          {/* Title */}
          <h1 className="text-2xl sm:text-4xl md:text-5xl max-w-[500px] font-regular text-white mb-4">
            Luxury Gifts That
