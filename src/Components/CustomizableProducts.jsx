  ...
  useEffect(() => {
    const fetchProduct = async () => {
      ...
      try {
        ...
        const page = Math.ceil(productId / productsPerPage);
        ...
        setRelatedProducts(
          formattedProducts.filter(
            (p) =>
              p.category === (foundProduct.category || "Uncategorized") &&
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                <img
                  src={product.image}
                  alt={product.name}
                  className="w-full h-80 object-contain bg-[#F4F2F2] p-4 rounded"
                />
              </div>
              <div>
                ...
                {product.customize ? (
                  <button
                    ...
                    className="bg-[#5F1327] hover:bg-[#5F1327]/70 text-white font-medium py-3 px-6 rounded-lg transition-colors"
                  >
                    Customize
                  </button>
                ) : (
