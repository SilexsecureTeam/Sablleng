...
const BrandForm = ({ onSave, onCancel }) => {
  ...
  const handleSaveBrand = async () => {
    ...
    try {
      ...
      const response = await fetch("https://api.sablle.ng/api/brand", {
        method: "POST",
      ...
      const createdBrand = data.brands || data;

      onSave({
        id: createdBrand.id,
        name: createdBrand.name || formData.name,
        description: createdBrand.description || formData.description,
        logo: createdBrand.logo || null,
        website: createdBrand.website || "",
        isActive: createdBrand.is_active ?? true,
        createdAt: createdBrand.created_at || new Date().toISOString(),
      });
